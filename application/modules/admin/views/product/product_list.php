            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                      <?php echo anchor(site_url($module.'/product/create'), '+ Tambah Data', 'class="btn btn-primary"'); ?>
      	    </div>
              </div>
                        ...
                        <tbody>
                          <?php foreach ($dataproduct as $d): ?>
                            <tr>
                              ...
                              <?php endforeach; ?>
                                <td>
                                <a href="<?php echo base_url().$module?>/product/edit/<?php echo $d->id_product ?>">
                                        <button class="btn btn-success waves-effect waves-light m-r-10">Edit</button>
                                    </a>
                                    <a href="<?php echo base_url().$module?>/product/delete/<?php echo $d->id_product ?>">
