...
<body>
  ...
  <div class="login-box card">
    <div class="card-body">
      <form class="form-horizontal form-material" id="loginform" method="post" action="<?php echo base_url()."register/createRegister" ?>">
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="text" name="store_title" required="" placeholder="Enter Your Store Title">
          </div>
        </div>
        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="date" name="date" required="" placeholder="Enter Your Address">
          </div>
        </div>
<!--         <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="address" required="" placeholder="Enter Your Address">
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12">
        ...
        <div class="form-group m-b-0">
          <div class="col-sm-12 text-center">
            <p>Already have an account? <a href="<?php echo base_url()."login" ?>" class="text-info m-l-5"><b>Sign In</b></a></p>
          </div>
        </div>
      </form>
    </div>
